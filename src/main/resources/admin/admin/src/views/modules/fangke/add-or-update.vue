	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="电子邮件" prop="dianziyoujian">
					<el-input v-model="ruleForm.dianziyoujian" placeholder="电子邮件" clearable  :readonly="ro.dianziyoujian"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="电子邮件" prop="dianziyoujian">
...
export default {
	data() {
		...
		return {
			...
			rules: {
				fangkezhanghao: [
					{ required: true, message: '访客账号不能为空', trigger: 'blur' },
				],
				mima: [
